...
What is the relationship between shannon surprise (influenced by gamma and
alpha) and RT?

Betas are of the opposite sign because of the inverse link.
You can imagine it as a flipping of the x-axis (inverse link = large numbers get
small, small numbers get large).
That's why the direction of the relationship changes: low surprise values are
now on the far end of the x-axis, and if low surprise means fast reaction, the
relationship is not negative (negative beta).

See [here](https://www.causact.com/linear-predictors-and-inverse-link-functions.html)
under 23.2, point 2 "Inverse Logit".
